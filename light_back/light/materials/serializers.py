...
class SelfAssignmentTaskTemplateSerializer(serializers.ModelSerializer):
    str = serializers.SerializerMethodField()
    creator = serializers.StringRelatedField()
    editor = serializers.StringRelatedField()
...
class MaterialСontentSerializer(serializers.ModelSerializer):
    categories = CategoryBaseSerializer(many=True, required=False)
...
class MaterialEditSerializer(serializers.ModelSerializer):
    content = serializers.CharField(required=False, style={'base_template': 'textarea.html'})
    avatar = serializers.ImageField(required=False)
